...
public class OxidationPropertiesLantern extends LanternBlock implements Oxidizable {
    private final OxidationLevel oxidationLevel;

    public OxidationPropertiesLantern(OxidationLevel oxidationLevel, Settings settings) {
